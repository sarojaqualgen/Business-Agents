    ...
    <div className="flex flex-col h-[calc(100vh-140px)] card overflow-hidden">
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b border-border flex-shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-sm font-semibold text-text leading-none">Aldergate Assistant</p>
            {messages.length > 0 && (
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-5 flex flex-col gap-4">
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center gap-4 text-center px-6">
            ...
            <div>
              <h2 className="text-sm font-semibold text-text mb-1">Ask Aldergate anything</h2>
